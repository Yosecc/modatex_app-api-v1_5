...
class Marca extends Controller
{
    ...
    private function getCategoria($store)
    {
        ...
        $categorieR = $this->sortCategories($store['membership']);
        // dd( $categorieR);
        ...
        if($store['default_section']!=''){
          // dd($store,$categorieR,$categoriesBase);
          $predefSection = collect($categoriesBase)->where('key', $store['default_section'])->first();
          $c = $predefSection['key'];
        }elseif($store['default_section']==''){
